    ...
    <div className="h-screen w-full sticky top-0 bg-white px-20 py-4 flex flex-col justify-between">
      ...
      <div>
        ...
        <div className="flex justify-between items-center">
          ...
          <p>The central trapezoidal wing with a small elongation, equipped with leading-edge extensions,
smoothly joins with the fuselage, forming a single load-bearing body. Two AL-31F 3rd series twocircuit turbojet engines with afterburners are placed in separate nacelles placed under the aircraft's
chassis separately from each other such that it eliminates their aerodynamic interference and allows
for the placement of the aircraft's weapons, as well as the buddy refueling system, in the space
between. The variable supersonic air intakes are located under the center wing and are equipped
with a protective device that prevents foreign object debris from entering the engines during the
aircraft's take-off and landing modes.</p>
        </div>
      </div>
