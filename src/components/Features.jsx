...
//     if (activeFeature === "stealth") {
//       // You'll need to find the specific mesh or material to change
//       jetRef.current.traverse((child) => {
//         if (child.isMesh) {
...
//           newMaterial.emissive = new THREE.Color(0x000000); // A bright green glow
